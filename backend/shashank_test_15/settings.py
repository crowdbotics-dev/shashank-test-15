"""
Django settings for shashank_test_15 project.
...
ROOT_URLCONF = 'shashank_test_15.urls'
...
WSGI_APPLICATION = 'shashank_test_15.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "shashank-test Support <support@shashank-test-15.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shashank_test_15 API",
    "DESCRIPTION": "API documentation for shashank_test_15 App",
    "VERSION": "v1",
}
